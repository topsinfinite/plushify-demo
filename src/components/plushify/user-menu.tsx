        ...
        <DropdownMenuLabel className="font-normal">
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg">
              ...
              <Badge variant={mockUser.credits < 10 ? "destructive" : "secondary"} className="text-xs">
                {mockUser.credits < 10 ? "Low" : "Available"}
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="text-center p-2 bg-muted/50 rounded">
                <div className="font-medium">{mockUser.totalGenerations}</div>
                <div className="text-muted-foreground">Generated</div>
              </div>
              <div className="text-center p-2 bg-muted/50 rounded">
                <div className="font-medium">{mockUser.favoriteCount}</div>
