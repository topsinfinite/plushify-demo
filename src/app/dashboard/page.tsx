...
export default function DashboardPage() {
  ...
  const isLowCredits = mockUser.credits < 10;
      ...
      {isLowCredits && (
        <Alert className="mb-6 border-orange-200 bg-orange-50 dark:bg-orange-900/10">
          ...
          <AlertDescription className="text-orange-800 dark:text-orange-200">
            You&apos;re running low on credits! You have {mockUser.credits} credits remaining.{" "}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <div>
                  <p className="font-semibold text-lg">{mockUser.credits} credits available</p>
                  <p className="text-sm text-muted-foreground">
                    Each generation costs 1 credit • {mockUser.creditsUsed} credits used to date
                  </p>
                </div>
                <Button asChild>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-green-600">{mockUser.credits}</p>
                  <p className="text-xs text-muted-foreground">Available</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-blue-600">{mockUser.creditsUsed}</p>
                  <p className="text-xs text-muted-foreground">Used</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-purple-600">{mockUser.credits + mockUser.creditsUsed}</p>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                  ...
                  <span className="font-semibold">{mockUser.totalGenerations}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                  ...
                  <span className="font-semibold">{mockUser.favoriteCount}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                  ...
                  <span className="font-semibold">{mockUser.creditsUsed}</span>
                </div>
              </div>
            </CardContent>
          </Card>
